...
{p}{bf:Example 1.} Analysis of individual participant data (which are not publicly available) from the Fibrinogen Studies Collaboration data ({help mvmeta_make##White09:White, 2009}). 
